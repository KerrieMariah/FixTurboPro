        ...
        <div className="row gy-30">
          <div className="col-lg-4 process-card-wrap">
            <div className="process-card">
              ...
              We thoroughly inspect your vehicle to pinpoint the root cause of the issue.
              </p>
            </div>
          </div>
          <div className="col-lg-4 process-card-wrap">
            <div className="process-card process-card-center">
              ...
              <p className="process-card-text">
              Once we’ve identified the problem, we make the necessary repairs using high-quality parts and proven techniques.
              </p>
            </div>
          </div>
          <div className="col-lg-4 process-card-wrap">
            <div className="process-card">
              ...
              <p className="process-card-text">
              After completing the repairs, we perform comprehensive tests to confirm your vehicle is operating at peak performance.
              </p>
            </div>
          </div>
        </div>
